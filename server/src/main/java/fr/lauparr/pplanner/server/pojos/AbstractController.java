...
import fr.lauparr.pplanner.server.utils.ControllerUtils;
...
public abstract class AbstractController {
	...
	public ResponseEntity message(String message) {
		return ResponseEntity.ok(ControllerUtils.createMessageResponse(Level.SEVERE, message));
	}
	...
	public ResponseEntity message(String message, Level level) {
		return ResponseEntity.ok(ControllerUtils.createMessageResponse(level, message));
	}
