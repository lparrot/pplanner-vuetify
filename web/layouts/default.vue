...
export default class LayoutDefault extends Vue {
  ...
  mini: boolean = true
  menu: any[] = []
  sheetDeconnexion: boolean = false
  sheetProjectSelection: boolean = false

  get isTabletAndMobile() {
    return this.$vuetify.breakpoint.mdAndDown
  }

  async middleware({$accessor}) {
    await $accessor.project.updateProjectList()
  }
  ...
  async selectProject(project) {
    ...
    await this.$accessor.project.selectProject(project)
