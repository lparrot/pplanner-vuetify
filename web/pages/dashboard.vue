<template>
  <section>
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-5">
      <nuxt-link v-for="(stat, statIndex) in statistics" :key="statIndex" :to="stat.to || ''" class="transition-all duration-500 ease-out cursor-pointer text-center border-2 border-gray-200 mx-1 px-4 py-6 rounded-lg transform lg:hover:scale-105" tag="div">
